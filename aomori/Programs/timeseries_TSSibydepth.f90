program tssigmabydepth
    ...
    ! real::dx,dy
    print*,months,years,size(r1),size(r2),size(r3)

    l = 1
    call plots(3.,0.5,9,'../Plots/Geostrophy/Timeseries/timeseries_sigmac5_2.ps')
    call symbol(0.,height+1.4,0.8,'time series of sigma theta',0.,len('time series of sigma theta'))
    call b2cy2y2r_colorgrad(27,5,10,20,r1,g1,b1) !temp
    ...
    ! print*,minval(sal_c5),maxval(sal_c5)
    ...
    do j = 1,obs_depth,50
        ...
        print*,minval(psarray2),minloc(psarray2)
        !temp
            ! call betcolork2(dx,-dy,psarray2,mask2,1,fin_st-ini_st+1,1,months*years,fin_st-ini_st+1,months*years,-100.,0.,r1(0),g1(0),b1(0))
            ! call betcolork2(dx,-dy,psarray2,mask2,1,fin_st-ini_st+1,1,months*years,fin_st-ini_st+1,months*years,27.,100.,r1(28),g1(28),b1(28))
            ! do n = 1, 27
    ...
    call plot(1.,0.,-3)
    !temp
    ! call colorscale_creator(27,r1,g1,b1,0.,27.,5,0.3,1,10.,.5,90,1,1)
    !sigma
