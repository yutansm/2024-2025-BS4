...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    call SSH_data(oku,ilabel = 3603,convert = .true., calibrate = .true.) !!!!!! is Tappi !!!!!!
    call SSH_data(sak, ilabel = 2605, convert = .true., calibrate = .true.) !!!!!! is Fukaura !!!!!!
    call SSH_data(tob, ilabel = 4703, convert = .true., calibrate = .true.) !!!!!! is Esashi !!!!!!
    ...
    esa(2,2)=-999.;esa(4,2)=-999.;tob(2,2)=-999.;tob(4,2)=-999. ! delete shady data
    ! obtain yearly means
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    call plots2('../Plots/Favorites/SSH_FukTap_FukEsa.ps',h = 'Title',oopt= 'otops')
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    call butler_linegraph(timeseries,25.,17.,-150.,150.,-999.,mem=.true.,memscale = 0.1,memiter = 7,memsymsize = 1.2,tlabel = 'Fukaura-Tappi')
    call mod12_memori(180,25.,symbol_size = 0.3,num_freq = 6)
    ...
    call butler_linegraph(timeseries,25.,17.,-150.,150.,-999.,mem=.true.,memscale = 0.1,memiter = 7,memsymsize = 1.2,tlabel = 'Esashi')
    call mod12_memori(180,25.,symbol_size = 0.3,num_freq = 6)
    ...
    do i = 1,15
        do n = 1, 12
            if(sak_tob(i,n)<=-150.)print*,'year = ',i,'month = ',n,'value = ',sak_tob(i,n)
        end do
    end do
    call butler_linegraph(timeseries,25.,17.,-150.,150.,0.,mem=.true.,memscale = 0.1,memiter = 7,memsymsize = 1.2,tlabel = 'Fukaura-Esashi')
    call mod12_memori(180,25.,symbol_size = 0.3,num_freq = 6)
