...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        call plots2(psfile='../Plots/Favorites/Correlations/Nst4_'//int2str(obs_depth)//'_Correlations.ps',x = 1.,y = -height+1.,oopt = 'otops', h = 'Auto and Cross Correlations for Station 4 at ' // int2str(obs_depth) // 'm')
        ! call num_memori(0.,162.,82,6,0.6,-1,width-width/163.,0,x = width/163./2.)
        call num_memori(0.,162.,82,symbol_freq = 6,symbol_size = 0.6,float_quantity = -1,length = width,gap = 2)
