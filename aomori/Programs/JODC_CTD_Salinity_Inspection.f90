program testing_butler_psbet
    ...
    real::lon1deg,lat1deg,freshwaterratio(0:12,126:142,32:46),somejodcarray(0:12,126:142,32:46)
    type(JODC_TS)::sal
    real,dimension(0:12,126:142,32:46,0:400)::Jsal400 ! linear interpolation for the first 12 layers 
    ...
    call JODC_data2(sal = sal,ilat = 32,flat = 46,ilon = 126,flon = 142,calibrate1 = .true.,info = .true.)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! Initial Inspection
    ...
    !             ! call butler_linegraph(sal_c5(y,m,1,1,:),15.,7.,32.5,35.,mem=stat,memloc = 'left',memsymfreq = 5,memfreq = 0.1,rotation = -90.,memflqt = 1,lthick = 1,memsymsize = 0.6)
