program tssigma201
    ...
    real,dimension(:),allocatable::rsal,gsal,bsal
...
!  
        ...
        !temp of N line
        call butler_psbet(psarray2(1,1:fin_st-ini_st+1,1:180),fin_st-ini_st+1,months*years,width,-height,0.,0.,12.,1.,'b2r',12,bpt1=5,conti = 0., continc = 1.,r= r1,g=g1,b=b1,thicc=5)
    ...
    call plot(width+0.5,0.,-3)
        ...
        call num_memori(0.,12.,12,5,0.5,1,-width5,0,x=width5,y=-height)
        ...
        call num_memori(0.,12.,12,5,0.5,1,-height2/2.,-90,y=height2/2.);call num_memori(0.,12.,12,5,0.5,1,height2/2.,-90,y=height2/2.)
...
!above standard deviation
    ! PS
        ...
        call butler_psk(ymmeanabove,6,depth,width3,-height3,0.,33.95,34.30,0.05,'b2w2r',7,bpt1=4,r=rsal,g=gsal,b=bsal)!,conti=33.8,continc=0.05,r=rsal,g=gsal,b=bsal,thicc=2
        ...
        call avsemdata_3D(mmean(1:15,1:6,1:depth),15,6,depth,'dim1',ymmeanabove)
        call butler_cont(ymmeanabove,6,depth,width3,-height3,0.,0.,1.,thicc=5)
    ...
    !density
        ...
        call avsemdata_3D(mmean(1:15,1:6,1:depth),15,6,depth,'dim1',ymmeanabove)
        call butler_cont(ymmeanabove,6,depth,width3,-height3,0.,20.,0.2,thicc=5)
    ...
    !velocity
        ...
        call butler_psmask(ymmeanabove,5,depth,width3,-height3,-40.,0.,r=0.8,g=0.8,b=0.8,gap =1)
        call butler_cont(ymmeanabove,5,depth,width3,-height3,0.,-40.,2.,thicc=5,gap=1)
...
! below standard deviation
    ! PS
        ...
        call butler_psk(ymmeanbelow,6,depth,width3,-height3,0.,33.95,34.30,0.05,'b2w2r',7,bpt1=4,r=rsal,g=gsal,b=bsal)!,conti=33.8,continc=0.05,r=rsal,g=gsal,b=bsal,thicc=2
    ...
    !density  
        ...
        call avsemdata_3D(mmean(1:15,1:6,1:depth),15,6,depth,'dim1',ymmeanbelow)
        call butler_cont(ymmeanbelow,6,depth,width3,-height3,0.,20.,0.2,thicc=5)
    ...
    !velocity
        ...
        call butler_psmask(ymmeanbelow,5,depth,width3,-height3,-40.,0.,r=0.8,g=0.8,b=0.8,gap =1)
        call butler_cont(ymmeanbelow,5,depth,width3,-height3,0.,-40.,2.,thicc=5,gap=1)
...
!above sd - below sd and tests
    !density diff
        ...
        call avsemdata_4D(psden(1,1:15,1:months,1:6,1:depth),15,months,6,depth,'dim2',mmean)
        call avsemdata_3D(mmean(1:15,1:6,1:depth),15,6,depth,'dim1',mean_2D=ymmean1,s_2D=ymsem1,dataquan_2D=ymdata1) !above                     !sem array corrected to s array name mistake
        call avsemdata_4D(psden(2,1:15,1:months,1:6,1:depth),15,months,6,depth,'dim2',mmean)
        call avsemdata_3D(mmean(1:15,1:6,1:depth),15,6,depth,'dim1',mean_2D=ymmean2,s_2D=ymsem2,dataquan_2D=ymdata2) !below
        ...
        call num_memori(0.,400.,40,10,0.4,-1,-height3,-90)
        call st_memori(1,6,width3,1,0.4,0,y=-height3)
        call butler_psmask(ymmeandiffd,6,depth,width3,-height3,-2.,0.,r=0.8,g=0.8,b=0.8)
    ...
    call plot(width3+0.5,0.,-3)
        ...
        call butler_imask(resultd,6,depth,width3,-height3,0)
        call butler_imask(resultd,6,depth,width3,-height3,1,r=1.,g=0.5,b=0.5)
        call butler_imask(resultd,6,depth,width3,-height3,-1,r=0.5,g=0.5,b=1.)
    call plot(width3+0.5,0.,-3)
    !geovel diff
        call avsemdata_4D(psvel(1,1:15,1:months,1:5,1:depth),15,months,5,depth,'dim2',mmean)
        ...
        call memori(40,0.1,10,-height3,-90.,y=-height3/2.)
        call st_memori(1,6,width3,1,0.4,0,y=-height3)
        call butler_psmask(ymmeandiffv,5,depth,width3,-height3,-40.,0.,r=0.8,g=0.8,b=0.8,gap =1)
        call butler_cont(ymmeandiffv,5,depth,width3,-height3,0.,-40.,2.,thicc=5,r=0.,g=0.,b=0.,gap=1)
    ! end first page
...
! PS
    ...
    call butler_psk(ymmean1819,6,depth,width3,-height3,0.,33.95,34.30,0.05,'b2w2r',7,bpt1=4)
...
!velocity
    ...
    call butler_psmask(ymmean1819,5,depth,width3,-height3,-40.,0.,r=0.8,g=0.8,b=0.8,gap =1)
    call butler_cont(ymmean1819,5,depth,width3,-height3,0.,-40.,2.,thicc=5,gap=1)
...
!PS
    ...
    call butler_psk(ymmeanex1819,6,depth,width3,-height3,0.,33.95,34.30,0.05,'b2w2r',7,bpt1=4)!,conti=33.8,continc=0.05,r=rsal,g=gsal,b=bsal,thicc=2
    ...
    call avsemdata_3D(mmean(1:15,1:6,1:depth),15,6,depth,'dim1',ymmeanex1819)
    call butler_cont(ymmeanex1819,6,depth,width3,-height3,0.,0.,1.,thicc=5)
...
!velocity
    ...
    call butler_psmask(ymmeanex1819,5,depth,width3,-height3,-40.,0.,r=0.8,g=0.8,b=0.8,gap =1)
    call butler_cont(ymmeanex1819,5,depth,width3,-height3,0.,-40.,2.,thicc=5,r=0.,g=0.,b=0.,gap=1)
...
!density diff
    ...
    call avsemdata_4D(psden(3,1:15,1:months,1:6,1:depth),15,months,6,depth,'dim2',mmean)
    call avsemdata_3D(mmean(1:15,1:6,1:depth),15,6,depth,'dim1',mean_2D=ymmean1,s_2D=ymsem1,dataquan_2D=ymdata1) 
    call avsemdata_4D(psden(4,1:15,1:months,1:6,1:depth),15,months,6,depth,'dim2',mmean)
    call avsemdata_3D(mmean(1:15,1:6,1:depth),15,6,depth,'dim1',mean_2D=ymmean2,s_2D=ymsem2,dataquan_2D=ymdata2) 
    ymmeandiffd = ymmean1-ymmean2
    print*,minval(ymmeandiffd),maxval(ymmeandiffd),minloc(ymmeandiffd),maxloc(ymmeandiffd),'1819-ex1819,density'
    call num_memori(0.,400.,40,10,0.4,-1,-height3,-90)
    call symbolc(width3/2.,0.3,0.5,'Density',0.)
    call st_memori(1,6,width3,1,0.4,0,y=-height3)
    call butler_psmask(ymmeandiffd,6,depth,width3,-height3,-1.,0.,r=0.8,g=0.8,b=0.8)
