program geovel_with_different_reference_level
    ...
    real,dimension(14)::loop12,loop23,loop34,loop45,loop56
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! index 6 corresponds to station 1, it is flipped !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    ! geovel400
        ...
        call butler_linegraph(loop12(:13),width2,height2,0.,30.,0.,.true.,memsymfreq = 5,maskbelow = 0.,lthick = 8,rl = 1.)
    ...
    ! geovel100
        ...
        call plotback('third')
        call butler_linegraph(loop12(:13),width2,height2,0.,20.,0.,.true.,memsymfreq = 5,lthick = 8,rl = 1.,memsymsize = 0.65)
    ...
    ! geovel50
        ...
        call plotback('third')
        call butler_linegraph(loop12(:13),width2,height2,0.,10.,0.,.true.,memsymfreq = 5,lthick = 8,rl = 1.,memsymsize = 0.65)
