program TS_diagram_aomori
    ...
    if(obs_line==1)then
        call plots(2.5,13.5,13,'/LARGE0/gr10291/nishimori2/aomori/TS_Diagrams/TS_diagram_monthly_NLine_25ver2.ps')
        call symbol(1.,5.5,1.,'Monthly TS Diagrams at N-Line St1-6', 0.,len('monthly ts diagrams at N line St1-6'))
    else 
        call plots(2.5,13.5,13,'/LARGE0/gr10291/nishimori2/aomori/TS_Diagrams/TS_diagram_monthly_SLine_St1-6.ps')
        call symbol(1.,5.5,1.,'Monthly TS Diagrams at S-Line St1-6', 0.,len('monthly ts diagrams at S line St1-6'))
    end if
    call newpen2(3)
