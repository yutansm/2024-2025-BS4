program TS_diagram_aomori
    ...
    integer,parameter:: years = 4, months = 12, lines = 1, stations = 9,depth = 400
    ...
    if(lines==1)then
        call plots(2.5,13.5,13,'/LARGE0/gr10291/nishimori2/aomori/TS_Diagrams/TS_diagram_monthly_NLine_2012.ps')
        call symbol(1.,5.5,1.,'Monthly TS Diagrams at N-Line 2012', 0.,len('monthly ts diagrams at N line 2012'))
    else 
        call plots(2.5,13.5,13,'/LARGE0/gr10291/nishimori2/aomori/TS_Diagrams/TS_diagram_monthly_SLine_2012.ps')
        call symbol(1.,5.5,1.,'Monthly TS Diagrams at S-Line 2012', 0.,len('monthly ts diagrams at S line 2012'))
    end if
    call newpen2(3)
                ...
                do y = years, years
                    do d = 1, depth
                        ...
                        if(sal_5(y,m,l,st,d)/=0. .and. potemp_5(y,m,l,st,d)/=0.) then;call rgbk(r,g,b)
                            if (st<=3) then;call gmark(salco,tempco,0.1-real(st-1)/100.,1)
